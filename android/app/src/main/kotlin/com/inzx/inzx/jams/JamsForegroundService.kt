...
class JamsForegroundService : Service() {
    ...
    companion object {
        ...
        // Actions
        const val ACTION_START = "com.tuneload.app.jams.START"
        const val ACTION_STOP = "com.tuneload.app.jams.STOP"
        const val ACTION_UPDATE_NOTIFICATION = "com.tuneload.app.jams.UPDATE"
