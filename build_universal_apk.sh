...
echo -e "\033[0;36m=== TuneLoad Universal & Standalone APK Builder ===\033[0m\n"
...
UNIVERSAL_TARGET="$OUTPUT_DIR/tuneload-$VERSION_SAFE-universal.apk"
...
STRIPPED_APK="$OUTPUT_DIR/tuneload-$VERSION_SAFE-unaligned.apk"
FINAL_ARM64_APK="$OUTPUT_DIR/tuneload.apk"
