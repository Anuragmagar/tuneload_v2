...
class _SearchScreenState extends ConsumerState<SearchScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Artwork colors are reserved for Now Playing / mini player.
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          // TuneLoad wine gradient background (same as the main screen)
          Positioned.fill(
            child: DecoratedBox(
          ...
          // Backdrop overlay (blur + black layer) like the main screen
          Positioned.fill(
            child: ClipRect(
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            // TuneLoad-style red-bordered search field
            child: Container(
              height: 46,
              padding: const EdgeInsets.symmetric(horizontal: 14),
              decoration: BoxDecoration(
                color: const Color.fromRGBO(217, 107, 107, 0.10),
              ...
              child: Row(
                children: [
                  ...
                  const SizedBox(width: 4),
                  // Magnifier button like in TuneLoad
                  BouncyTouch(
                    style: BouncyStyle.button,
                    customScale: 0.85,
