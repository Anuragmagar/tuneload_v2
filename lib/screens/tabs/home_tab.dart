...
class _MusicHomeTabState extends ConsumerState<MusicHomeTab> {
  ...
  Color get _backgroundColor {
    // Artwork tints stay on Now Playing / mini player only.
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        // TuneLoad-style greeting
        _buildGreetingRow(),

        // "Search" heading
        _buildSearchHeading(),

        // TuneLoad-style download search bar
        _buildSearchBar(),
  ...
  /// TuneLoad-style greeting based on time of day
  ...
  /// "Search" heading like the TuneLoad home page
  ...
  /// TuneLoad-style red-bordered download search bar
    ...
    return Padding(
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Row(
            children: [
              const Icon(Iconsax.search_normal_1, size: 20, color: Colors.white),
