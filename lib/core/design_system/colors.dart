...
class InzxColors {
  ...
  /// Dark bottom navigation bar background (also used for the system
  /// navigation bar so the two blend seamlessly).
  static const Color darkBottomNavigation = Color.fromARGB(255, 56, 0, 0);
