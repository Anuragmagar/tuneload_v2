...
/// Provider for the effective accent color (user-selected, constant).
/// Artwork-derived colors are used ONLY inside the Now Playing screen and the
/// mini player; the rest of the app keeps the user's chosen accent.
