    ...
    _stateSubscription = _playerService.stateStream.listen((state) {
      ...
      unawaited(
        WidgetSyncService.syncPlaybackState(
          state,
          statusLabel: _playerService.isJamsModeEnabled ? 'TUNELOAD JAM' : null,
        ),
      );
    });
...
Future<InzxAudioHandler> initAudioService() async {
  ...
  return await AudioService.init(
    ...
    config: AudioServiceConfig(
      androidNotificationChannelId: 'com.tuneload.app',
      androidNotificationChannelName: 'TuneLoad Music',
